function Create_Policy_Assignment
{
	...
	echo "############################################Create Policy Assignment with REST API############################################" >> C:\tempdir_$DATE\Logs\AzureLog_$DATE.txt;
	...
	if($? -eq "True")
	{
		echo "Policy Assignment successfully created" >> C:\tempdir_$DATE\Logs\AzureLog_$DATE.txt;
	}
	else
	{
		echo "Policy Assignment deployment failed" >> C:\tempdir_$DATE\Logs\AzureLog_$DATE.txt;
	}	
