function Create_Policy_Definition
{
	...
	echo "############################################Create Policy Definition With REST API############################################" >> C:\tempdir_$DATE\Logs\AzureLog_$DATE.txt
	...
	if($? -eq "True")
	{
		echo "Policy Definition successfully created" >> C:\tempdir_$DATE\Logs\AzureLog_$DATE.txt;
	}
	else
	{
		echo "Policy Definition deployment failed" >> C:\tempdir_$DATE\Logs\AzureLog_$DATE.txt;
	}	
